...
#show: project.with(
  ...
  changelog: (
    ...
    (p.mahdi),
    [
      Verifica verbale, apportate correzioni
    ],
    "0.1",
    "2024-11-19",
    (p.benedetti),
...
- Suddivisione temporale degli sprint
...
== Test per il #glossary("Proof of Concept"), oltre che per il #glossary("Minimum Viable Product")
...
= Prossimi step
- Incontro per la retrospettiva dello sprint attuale, e per eventuali modifiche e/o analisi dello sprint successivo fissato per il 2024-12-03 alle ore 17:00
