...
Blocco di codice sorgente, in questo contesto, incluso in un documento o nella risposta del chatbot .
...
In questo contesto, termine per indicare l'operazione di recupero dati da una delle sorgenti utilizzate dal chatbot.
...
Esperienza complessiva di un utente durante l'interazione con un prodotto o servizio.
