...
\input{1 - Candidatura/lettera_di_presentazione/packages}
\input{1 - Candidatura/lettera_di_presentazione/variables}
...
\begin{document}
\pagestyle{mystyle}
\input{1 - Candidatura/lettera_di_presentazione/firstPage}
