...
\begin{titlepage}
\include{candidatura/verbali_esterni/verbale_esterno10-17/variables}
	\begin{tikzpicture}[remember picture, overlay]
		...
		\node[anchor=north west, opacity=1, yshift = 8cm, xshift= 1.3cm, scale=1.6] at (current page.south west) {\includegraphics[width=4cm]{images/logos/sweetenteam_nobg.png}};
	\end{tikzpicture}
	...
	\begin{center}
		\begin{flushright}
			{\fontsize{30pt}{52pt}\selectfont \textbf{Verbale Esterno \\ 17/10/2024 \\}} % o ESTERNO
		\end{flushright}
		\vspace{3cm}
	\end{center}
	\vspace{7.5 cm}
